     ...
     <script type="text/javascript">
            ...
            function sweetalert1(){
                Swal.fire({
                    ...
                    footer: '<a href="">Remova a(s) duplicação(ões) do banco e tente novamente</a>',
                    // timer: 1500 //(para um segundo e meio mostrando na tela)
                    //showConfirmButton: false //(para tirar o botao de confirmação)
                });                
            }
        ...
        <form action="" method="POST" class="px-4 py-3">
            ...
            <div class="mb-2" style="margin-top: 25px;">
                    <button type="submit" class="btn btn-primary form-control" name="confirma">Sign in</button>
                        <div class="teste" style="position: absolute; z-index: 10000;">
                            <?php
                                if(isset($_POST['confirma'])):
                                    ...
                                    if($stmt->rowCount() == 1){
                                        $info = $stmt->fetch(); //TESTE ISSO DEPOIS PARA PEGAR UM UNICO VALOR
                                        /*print_r($info);
                                        exit();*/
                                        ...
                                        //VERSÃO PRO: (tive que colocar top:25% no main porque estava subindo)
